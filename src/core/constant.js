...
(function() {
    ...
    const NAKSHATRAS = [
        { name: "Ashwini", lord: "Ketu", deity: "Ashwini Kumaras", gana: "Deva", nature: "Kshipra (Swift)", startDeg: 0, endDeg: 13.3333,
          interpretation: "Swift action, healing, new beginnings, horse-like energy" },
        { name: "Bharani", lord: "Venus", deity: "Yama", gana: "Manushya", nature: "Ugra (Fierce)", startDeg: 13.3333, endDeg: 26.6667,
          interpretation: "Transformation, letting go, deep karma, bearer of life" },
        { name: "Krittika", lord: "Sun", deity: "Agni", gana: "Rakshasa", nature: "Mixed", startDeg: 26.6667, endDeg: 40.0,
          interpretation: "Sharp intelligence, purification, courage, cutting through ignorance" },
        { name: "Rohini", lord: "Moon", deity: "Brahma", gana: "Manushya", nature: "Dhruva (Fixed)", startDeg: 40.0, endDeg: 53.3333,
          interpretation: "Creativity, fertility, material comforts, growth" },
        { name: "Mrigashira", lord: "Mars", deity: "Soma", gana: "Deva", nature: "Mridu (Soft)", startDeg: 53.3333, endDeg: 66.6667,
          interpretation: "Curiosity, searching, adventure, deer-like grace" },
        { name: "Ardra", lord: "Rahu", deity: "Rudra", gana: "Manushya", nature: "Tikshna (Dreadful)", startDeg: 66.6667, endDeg: 80.0,
          interpretation: "Destruction, rebuilding, emotional intensity, tears" },
        { name: "Punarvasu", lord: "Jupiter", deity: "Aditi", gana: "Deva", nature: "Chara (Movable)", startDeg: 80.0, endDeg: 93.3333,
          interpretation: "Return, renewal, optimism, restoration" },
        { name: "Pushya", lord: "Saturn", deity: "Brihaspati", gana: "Deva", nature: "Kshipra (Swift)", startDeg: 93.3333, endDeg: 106.6667,
          interpretation: "Nourishment, protection, spiritual growth, prosperity" },
        { name: "Ashlesha", lord: "Mercury", deity: "Nagas", gana: "Rakshasa", nature: "Tikshna (Dreadful)", startDeg: 106.6667, endDeg: 120.0,
          interpretation: "Mystery, wisdom, karmic healing, serpentine energy" },
        { name: "Magha", lord: "Ketu", deity: "Pitrs", gana: "Rakshasa", nature: "Ugra (Fierce)", startDeg: 120.0, endDeg: 133.3333,
          interpretation: "Ancestral power, authority, legacy, throne" },
        { name: "Purva Phalguni", lord: "Venus", deity: "Bhaga", gana: "Manushya", nature: "Ugra (Fierce)", startDeg: 133.3333, endDeg: 146.6667,
          interpretation: "Creativity, romance, pleasure, front of the bed" },
        { name: "Uttara Phalguni", lord: "Sun", deity: "Aryaman", gana: "Manushya", nature: "Dhruva (Fixed)", startDeg: 146.6667, endDeg: 160.0,
          interpretation: "Service, marriage, fulfillment, back of the bed" },
        { name: "Hasta", lord: "Moon", deity: "Savitar", gana: "Deva", nature: "Kshipra (Swift)", startDeg: 160.0, endDeg: 173.3333,
          interpretation: "Skill, manifestation, craftsmanship, hand" },
        { name: "Chitra", lord: "Mars", deity: "Vishwakarma", gana: "Rakshasa", nature: "Mridu (Soft)", startDeg: 173.3333, endDeg: 186.6667,
          interpretation: "Creativity, architecture, brilliance, bright jewel" },
        { name: "Swati", lord: "Rahu", deity: "Vayu", gana: "Deva", nature: "Chara (Movable)", startDeg: 186.6667, endDeg: 200.0,
          interpretation: "Independence, movement, adaptability, sword" },
        { name: "Vishakha", lord: "Jupiter", deity: "Indra-Agni", gana: "Rakshasa", nature: "Mixed", startDeg: 200.0, endDeg: 213.3333,
          interpretation: "Determination, focus, transformation, forked" },
        { name: "Anuradha", lord: "Saturn", deity: "Mitra", gana: "Deva", nature: "Mridu (Soft)", startDeg: 213.3333, endDeg: 226.6667,
          interpretation: "Friendship, devotion, success, following Radha" },
        { name: "Jyeshtha", lord: "Mercury", deity: "Indra", gana: "Rakshasa", nature: "Tikshna (Dreadful)", startDeg: 226.6667, endDeg: 240.0,
          interpretation: "Wisdom, seniority, protection, eldest" },
        { name: "Mula", lord: "Ketu", deity: "Nirriti", gana: "Rakshasa", nature: "Tikshna (Dreadful)", startDeg: 240.0, endDeg: 253.3333,
          interpretation: "Roots, destruction, rebirth, root" },
        { name: "Purva Ashadha", lord: "Venus", deity: "Apas", gana: "Manushya", nature: "Ugra (Fierce)", startDeg: 253.3333, endDeg: 266.6667,
          interpretation: "Invigoration, purification, optimism, earlier victory" },
        { name: "Uttara Ashadha", lord: "Sun", deity: "Vishwadevas", gana: "Manushya", nature: "Dhruva (Fixed)", startDeg: 266.6667, endDeg: 280.0,
          interpretation: "Victory, perseverance, leadership, later victory" },
        { name: "Shravana", lord: "Moon", deity: "Vishnu", gana: "Deva", nature: "Chara (Movable)", startDeg: 280.0, endDeg: 293.3333,
          interpretation: "Learning, listening, wisdom, ear" },
        { name: "Dhanishta", lord: "Mars", deity: "Vasus", gana: "Rakshasa", nature: "Chara (Movable)", startDeg: 293.3333, endDeg: 306.6667,
          interpretation: "Wealth, music, prosperity, drum" },
        { name: "Shatabhisha", lord: "Rahu", deity: "Varuna", gana: "Rakshasa", nature: "Chara (Movable)", startDeg: 306.6667, endDeg: 320.0,
          interpretation: "Healing, mystery, secrets, hundred physicians" },
        { name: "Purva Bhadrapada", lord: "Jupiter", deity: "Aja Ekapada", gana: "Manushya", nature: "Ugra (Fierce)", startDeg: 320.0, endDeg: 333.3333,
          interpretation: "Spiritual warrior, purification, front of the funeral cot" },
        { name: "Uttara Bhadrapada", lord: "Saturn", deity: "Ahir Budhnya", gana: "Manushya", nature: "Dhruva (Fixed)", startDeg: 333.3333, endDeg: 346.6667,
          interpretation: "Wisdom, compassion, finality, back of the funeral cot" },
        { name: "Revati", lord: "Mercury", deity: "Pushan", gana: "Deva", nature: "Mridu (Soft)", startDeg: 346.6667, endDeg: 360.0,
